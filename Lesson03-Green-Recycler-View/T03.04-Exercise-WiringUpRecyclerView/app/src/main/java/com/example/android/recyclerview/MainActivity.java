...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // DONE (6) Use setLayoutManager on mNumbersList with the LinearLayoutManager
        //          we created above
        mNumbersList.setLayoutManager(layoutManager);

        // DONE (7) Use setHasFixedSize(true) to designate that the contents of the RecyclerView
