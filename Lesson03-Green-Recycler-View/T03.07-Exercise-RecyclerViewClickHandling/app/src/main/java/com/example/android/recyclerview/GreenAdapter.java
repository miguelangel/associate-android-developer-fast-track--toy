...
public class GreenAdapter extends RecyclerView.Adapter<GreenAdapter.NumberViewHolder> {
    ...
    // DONE (4) Add a ListItemClickListener as a parameter to the constructor and store it
    //          in mOnClickListener
    /**
    ...
    class NumberViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public NumberViewHolder(View itemView) {
            ...
            // DONE (7) Call setOnClickListener on the View passed into the constructor
        ...
        // DONE (6) Override onClick, passing the clicked item's position (getAdapterPosition())
