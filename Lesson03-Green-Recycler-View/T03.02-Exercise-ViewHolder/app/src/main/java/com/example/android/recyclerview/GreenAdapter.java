...
public class GreenAdapter extends RecyclerView.Adapter<GreenAdapter.NumberViewHolder> {
    ...
    class NumberViewHolder extends RecyclerView.ViewHolder {
        ...
        // DONE (14) Create a constructor for NumberViewHolder that accepts a View called itemView
        //           as a parameter
        public NumberViewHolder(View itemView) {
            // DONE (15) Within the constructor, call super(itemView) and then
            //           find listItemNumberView by ID
            super(itemView);
            mListItemNumberView = (TextView) itemView.findViewById(R.id.tv_item_number);
        }

        // DONE (16) Within the NumberViewHolder class, create a void method called bind that
        //           accepts an int parameter called listIndex
        private void bind (int listIndex) {
            // DONE (17) Within bind, set the text of listItemNumberView to the listIndex
            // DONE (18) Be careful to get the String representation of listIndex, as using
