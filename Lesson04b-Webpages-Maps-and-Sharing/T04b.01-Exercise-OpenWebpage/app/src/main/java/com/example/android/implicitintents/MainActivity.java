...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickOpenWebpageButton(View v) {
        // DONE (5) Create a String that contains a URL
        //          ( make sure it starts with http:// or https:// )
        String url = "http://www.dirigendo.com";

        // DONE (6) Replace the Toast with a call to openWebPage, passing in the URL String
