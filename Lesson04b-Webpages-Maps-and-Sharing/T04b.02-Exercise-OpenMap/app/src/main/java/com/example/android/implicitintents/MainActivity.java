...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickOpenAddressButton(View v) {
        ...
        String address = "Plaza de Cibeles, Madrid";

        // DONE (6) Use Uri.Builder with the appropriate scheme and
        //          query to form the Uri for the address
        Uri location = new Uri.Builder()
                .scheme("geo")
                .path("0,0")
                .appendQueryParameter("q", address)
                .build();

        // DONE (7) Replace the Toast with a call to showMap, passing in
        //          the Uri from the previous step
        showMap(location);
    }
