...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == R.id.action_search) {
            // DONE (13) If the item's ID is R.id.action_search, show a Toast and return true
            // //        to tell Android that you've handled this menu click
            // DONE (14) Don't forgot to call .show() on your Toast
            Toast.makeText(MainActivity.this, "Search clicked", Toast.LENGTH_SHORT).show();
            return true;
        }

        // DONE (15) If you do NOT handle the menu click, return super.onOptionsItemSelected to
